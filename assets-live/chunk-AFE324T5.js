...
var ICONS = {
  add: async () => (await import("./chunk-NLMMB7OZ.js")).addSvg,
  allWallets: async () => (await import("./chunk-K3FJLLAL.js")).allWalletsSvg,
  arrowBottomCircle: async () => (await import("./chunk-2O7XAFTV.js")).arrowBottomCircleSvg,
  appStore: async () => (await import("./chunk-NLJ5FRV5.js")).appStoreSvg,
  apple: async () => (await import("./chunk-UDBS3VFU.js")).appleSvg,
  arrowBottom: async () => (await import("./chunk-CBBWM5BR.js")).arrowBottomSvg,
  arrowLeft: async () => (await import("./chunk-RX4ALFJO.js")).arrowLeftSvg,
  arrowRight: async () => (await import("./chunk-ZWPIIRAM.js")).arrowRightSvg,
  arrowTop: async () => (await import("./chunk-APE3XKA7.js")).arrowTopSvg,
  bank: async () => (await import("./chunk-EGYSPIIS.js")).bankSvg,
  browser: async () => (await import("./chunk-6DVS6TS7.js")).browserSvg,
  card: async () => (await import("./chunk-5U5CG5JO.js")).cardSvg,
  checkmark: async () => (await import("./chunk-VFLEFVFI.js")).checkmarkSvg,
  checkmarkBold: async () => (await import("./chunk-VX4MSFIX.js")).checkmarkBoldSvg,
  chevronBottom: async () => (await import("./chunk-TPHHTXON.js")).chevronBottomSvg,
  chevronLeft: async () => (await import("./chunk-HIDU4DCC.js")).chevronLeftSvg,
  chevronRight: async () => (await import("./chunk-QU4L2LLQ.js")).chevronRightSvg,
  chevronTop: async () => (await import("./chunk-66VIVCF5.js")).chevronTopSvg,
  chromeStore: async () => (await import("./chunk-LEFQDCXW.js")).chromeStoreSvg,
  clock: async () => (await import("./chunk-D53V5NLJ.js")).clockSvg,
  close: async () => (await import("./chunk-CBTXMOYL.js")).closeSvg,
  compass: async () => (await import("./chunk-TW7OP6J4.js")).compassSvg,
  coinPlaceholder: async () => (await import("./chunk-EACKL4TQ.js")).coinPlaceholderSvg,
  copy: async () => (await import("./chunk-QAFWBWVV.js")).copySvg,
  cursor: async () => (await import("./chunk-RYUTLCXT.js")).cursorSvg,
  cursorTransparent: async () => (await import("./chunk-BZINFWJN.js")).cursorTransparentSvg,
  desktop: async () => (await import("./chunk-NMDVCWEQ.js")).desktopSvg,
  disconnect: async () => (await import("./chunk-NINKOPVE.js")).disconnectSvg,
  discord: async () => (await import("./chunk-SRZIPY6J.js")).discordSvg,
  etherscan: async () => (await import("./chunk-AOMYSV7I.js")).etherscanSvg,
  extension: async () => (await import("./chunk-UVANMJFK.js")).extensionSvg,
  externalLink: async () => (await import("./chunk-LLBVXNCZ.js")).externalLinkSvg,
  facebook: async () => (await import("./chunk-I2JQRPF6.js")).facebookSvg,
  farcaster: async () => (await import("./chunk-UKMF7JWC.js")).farcasterSvg,
  filters: async () => (await import("./chunk-WZXUC72P.js")).filtersSvg,
  github: async () => (await import("./chunk-7IEKNV47.js")).githubSvg,
  google: async () => (await import("./chunk-WRWYQAV5.js")).googleSvg,
  helpCircle: async () => (await import("./chunk-ZPWKUWHF.js")).helpCircleSvg,
  image: async () => (await import("./chunk-M32TW6U5.js")).imageSvg,
  id: async () => (await import("./chunk-G6FY54R2.js")).idSvg,
  infoCircle: async () => (await import("./chunk-I37MOKTW.js")).infoCircleSvg,
  lightbulb: async () => (await import("./chunk-TSKZWYGU.js")).lightbulbSvg,
  mail: async () => (await import("./chunk-XXL4BNY6.js")).mailSvg,
  mobile: async () => (await import("./chunk-RRRB2SUT.js")).mobileSvg,
  more: async () => (await import("./chunk-UEH7MF4X.js")).moreSvg,
  networkPlaceholder: async () => (await import("./chunk-WP4ZFWEQ.js")).networkPlaceholderSvg,
  nftPlaceholder: async () => (await import("./chunk-TA3KHHIH.js")).nftPlaceholderSvg,
  off: async () => (await import("./chunk-SGDTCBHZ.js")).offSvg,
  playStore: async () => (await import("./chunk-OHTPEYNY.js")).playStoreSvg,
  plus: async () => (await import("./chunk-7THBO5OC.js")).plusSvg,
  qrCode: async () => (await import("./chunk-R6QBHZ7Z.js")).qrCodeIcon,
  recycleHorizontal: async () => (await import("./chunk-DVPIYZX5.js")).recycleHorizontalSvg,
  refresh: async () => (await import("./chunk-QENOY55S.js")).refreshSvg,
  search: async () => (await import("./chunk-OGDUFJEE.js")).searchSvg,
  send: async () => (await import("./chunk-PAMGDWCU.js")).sendSvg,
  swapHorizontal: async () => (await import("./chunk-ICGGVIEC.js")).swapHorizontalSvg,
  swapHorizontalMedium: async () => (await import("./chunk-7ELES236.js")).swapHorizontalMediumSvg,
  swapHorizontalBold: async () => (await import("./chunk-44A4VUVD.js")).swapHorizontalBoldSvg,
  swapHorizontalRoundedBold: async () => (await import("./chunk-TFL3LABL.js")).swapHorizontalRoundedBoldSvg,
  swapVertical: async () => (await import("./chunk-HIP5FYHS.js")).swapVerticalSvg,
  telegram: async () => (await import("./chunk-UQ4XCJED.js")).telegramSvg,
  threeDots: async () => (await import("./chunk-4XTJWPUZ.js")).threeDotsSvg,
  twitch: async () => (await import("./chunk-6NOG2FHQ.js")).twitchSvg,
  twitter: async () => (await import("./chunk-2KYZLRRX.js")).xSvg,
  twitterIcon: async () => (await import("./chunk-ZOBCS5P2.js")).twitterIconSvg,
  verify: async () => (await import("./chunk-ZEEYUN35.js")).verifySvg,
  verifyFilled: async () => (await import("./chunk-SMZGGI2F.js")).verifyFilledSvg,
  wallet: async () => (await import("./chunk-YHZZBQ66.js")).walletSvg,
  walletConnect: async () => (await import("./chunk-ZPOH47QW.js")).walletConnectSvg,
  walletConnectLightBrown: async () => (await import("./chunk-ZPOH47QW.js")).walletConnectLightBrownSvg,
  walletConnectBrown: async () => (await import("./chunk-ZPOH47QW.js")).walletConnectBrownSvg,
  walletPlaceholder: async () => (await import("./chunk-MJGTNGKK.js")).walletPlaceholderSvg,
  warningCircle: async () => (await import("./chunk-V4XBQWBZ.js")).warningCircleSvg,
  x: async () => (await import("./chunk-2KYZLRRX.js")).xSvg,
  info: async () => (await import("./chunk-JXADBFNJ.js")).infoSvg,
  exclamationTriangle: async () => (await import("./chunk-KQY6GNRP.js")).exclamationTriangleSvg,
  reown: async () => (await import("./chunk-4UDJTR3F.js")).reownSvg
};

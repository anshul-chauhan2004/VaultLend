...
var R = class {
  ...
  u(t3) {
    const { el: { content: i5 }, parts: s4 } = this._$AD, e4 = (t3?.creationScope ?? l).importNode(i5, true);
    P.currentNode = e4;
...
var H = class {
  ...
  _$AI(t3, i5 = this, s4, e4) {
    ...
    if (void 0 === h3) t3 = M(this, t3, i5, 0), o5 = !a(t3) || t3 !== this._$AH && t3 !== E, o5 && (this._$AH = t3);
      ...
      const e5 = t3;
      let n4, r4;
      for (t3 = h3[0], n4 = 0; n4 < h3.length - 1; n4++) r4 = M(this, e5[s4 + n4], i5, n4), r4 === E && (r4 = this._$AH[n4]), o5 ||= !a(r4) || r4 !== this._$AH[n4], r4 === A ? t3 = A : t3 !== A && (t3 += (r4 ?? "") + h3[n4 + 1]), this._$AH[n4] = r4;
    }
    o5 && !e4 && this.j(t3);
  }
  j(t3) {
...
var D = (t3, i5, s4) => {
  ...
  if (void 0 === h3) {
    ...
    e4._$litPart$ = h3 = new k(i5.insertBefore(c(), t4), t4, void 0, s4 ?? {});
  }
...
var y2 = class extends HTMLElement {
  ...
  requestUpdate(t3, s4, i5, e4 = false, h3) {
    if (void 0 !== t3) {
      ...
      if (false === e4 && (h3 = this[t3]), i5 ??= r4.getPropertyOptions(t3), !((i5.hasChanged ?? f2)(h3, s4) || i5.useDefault && i5.reflect && h3 === this._$Ej?.get(t3) && !this.hasAttribute(r4._$Eu(t3, i5)))) return;
      this.C(t3, s4, i5);
    }

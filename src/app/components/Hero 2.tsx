    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-8 pt-16 pb-12 flex items-center gap-12" style={{ minHeight: "calc(100vh - 80px)" }}>
        ...
        <div className="flex-1 max-w-xl">
          ...
          >
            Deposit ETH, WBTC, or other major crypto assets as collateral and borrow USDC instantly. Maintain your long-term crypto exposure while accessing stablecoin liquidity. Smart contracts, transparent rates, full onchain security.
          </p>

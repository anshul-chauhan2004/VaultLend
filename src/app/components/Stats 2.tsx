const stats = [
  ...
  {
    label: "Isolated Market",
    value: "WETH/USDC",
    sub: "Single-market risk model",
    positive: null,
    icon: (
      <svg width="22" height="22" viewBox="0 0 22 22" fill="none">
        <circle cx="8" cy="11" r="5" stroke="#00e896" strokeWidth="1.5" fill="rgba(0,232,150,0.1)" />
        <circle cx="14" cy="11" r="5" stroke="#00e896" strokeWidth="1.5" fill="rgba(0,232,150,0.1)" />
      </svg>
    ),
  },
];

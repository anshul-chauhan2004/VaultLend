...
import {
  ...
  keccak256,
  toHex
} from "/assets/chunk-Y2F6XP2V.js";
import "/assets/chunk-6SXDBHBJ.js";
import {
  clear,
  createStore,
  del,
...
async function recoverPublicKey({ hash, signature }) {
  ...
  const { secp256k1 } = await import("/assets/secp256k1-FQB2RG22.js");
  const signature_ = (() => {
...
var hr = (t, e) => {
  ...
  const i3 = `URI: ${t.aud || t.uri}`, s = `Version: ${t.version}`, c4 = `Chain ID: ${lr(e)}`, a2 = `Nonce: ${t.nonce}`, u3 = `Issued At: ${t.iat}`, l4 = t.exp ? `Expiration Time: ${t.exp}` : void 0, f6 = t.nbf ? `Not Before: ${t.nbf}` : void 0, h4 = t.requestId ? `Request ID: ${t.requestId}` : void 0, y6 = t.resources ? `Resources:${t.resources.map((p4) => `
- ${p4}`).join("")}` : void 0, E7 = pe(t.resources);
  if (E7) {
    const p4 = yt(E7);
    o2 = Ke(o2, p4);
  }
  return [n2, r2, "", o2, "", i3, s, c4, a2, u3, l4, f6, h4, y6].filter((p4) => p4 != null).join(`
`);
};
function mr(t) {
...
function Ns(t, e) {
  ...
  return Fe(o2), Fe(s), Ar(i3), Ar(n2), (c4, a2, u3, l4, f6 = 0) => {
    ...
    const O5 = mt(a2);
    return Is(t, d3, v5, O5, u3, l4, f6, s), jt(...y6), l4;
  };
}
...
var Us = class {
  ...
  process(e, n2, r2 = false) {
    const o2 = r2 ? 0 : 2048, { h: i3, r: s } = this, c4 = s[0], a2 = s[1], u3 = s[2], l4 = s[3], f6 = s[4], h4 = s[5], y6 = s[6], E7 = s[7], p4 = s[8], d3 = s[9], v5 = F(e, n2 + 0), m2 = F(e, n2 + 2), O5 = F(e, n2 + 4), N4 = F(e, n2 + 6), $5 = F(e, n2 + 8), B4 = F(e, n2 + 10), A5 = F(e, n2 + 12), T3 = F(e, n2 + 14);
    ...
    x3 = C6 >>> 13, C6 &= 8191, C6 += g * (5 * h4) + w3 * (5 * f6) + b5 * (5 * l4) + I4 * (5 * u3) + R5 * (5 * a2), x3 += C6 >>> 13, C6 &= 8191;
    let P4 = x3 + S5 * a2 + L4 * c4 + U5 * (5 * d3) + _3 * (5 * p4) + j4 * (5 * E7);
    x3 = P4 >>> 13, P4 &= 8191, P4 += g * (5 * y6) + w3 * (5 * h4) + b5 * (5 * f6) + I4 * (5 * l4) + R5 * (5 * u3), x3 += P4 >>> 13, P4 &= 8191;
    let k7 = x3 + S5 * u3 + L4 * a2 + U5 * c4 + _3 * (5 * d3) + j4 * (5 * p4);
    x3 = k7 >>> 13, k7 &= 8191, k7 += g * (5 * E7) + w3 * (5 * y6) + b5 * (5 * h4) + I4 * (5 * f6) + R5 * (5 * l4), x3 += k7 >>> 13, k7 &= 8191;
    let M5 = x3 + S5 * l4 + L4 * u3 + U5 * a2 + _3 * c4 + j4 * (5 * d3);
    x3 = M5 >>> 13, M5 &= 8191, M5 += g * (5 * p4) + w3 * (5 * E7) + b5 * (5 * y6) + I4 * (5 * h4) + R5 * (5 * f6), x3 += M5 >>> 13, M5 &= 8191;
    let D4 = x3 + S5 * f6 + L4 * l4 + U5 * u3 + _3 * a2 + j4 * c4;
    x3 = D4 >>> 13, D4 &= 8191, D4 += g * (5 * d3) + w3 * (5 * p4) + b5 * (5 * E7) + I4 * (5 * y6) + R5 * (5 * h4), x3 += D4 >>> 13, D4 &= 8191;
    let z4 = x3 + S5 * h4 + L4 * f6 + U5 * l4 + _3 * u3 + j4 * a2;
    x3 = z4 >>> 13, z4 &= 8191, z4 += g * c4 + w3 * (5 * d3) + b5 * (5 * p4) + I4 * (5 * E7) + R5 * (5 * y6), x3 += z4 >>> 13, z4 &= 8191;
    let Z3 = x3 + S5 * y6 + L4 * h4 + U5 * f6 + _3 * l4 + j4 * u3;
    x3 = Z3 >>> 13, Z3 &= 8191, Z3 += g * a2 + w3 * c4 + b5 * (5 * d3) + I4 * (5 * p4) + R5 * (5 * E7), x3 += Z3 >>> 13, Z3 &= 8191;
    let st3 = x3 + S5 * E7 + L4 * y6 + U5 * h4 + _3 * f6 + j4 * l4;
    x3 = st3 >>> 13, st3 &= 8191, st3 += g * u3 + w3 * a2 + b5 * c4 + I4 * (5 * d3) + R5 * (5 * p4), x3 += st3 >>> 13, st3 &= 8191;
    let W4 = x3 + S5 * p4 + L4 * E7 + U5 * y6 + _3 * h4 + j4 * f6;
    x3 = W4 >>> 13, W4 &= 8191, W4 += g * l4 + w3 * u3 + b5 * a2 + I4 * c4 + R5 * (5 * d3), x3 += W4 >>> 13, W4 &= 8191;
    let J4 = x3 + S5 * d3 + L4 * p4 + U5 * E7 + _3 * y6 + j4 * h4;
    x3 = J4 >>> 13, J4 &= 8191, J4 += g * f6 + w3 * l4 + b5 * u3 + I4 * a2 + R5 * c4, x3 += J4 >>> 13, J4 &= 8191, x3 = (x3 << 2) + x3 | 0, x3 = x3 + C6 | 0, C6 = x3 & 8191, x3 = x3 >>> 13, P4 += x3, i3[0] = C6, i3[1] = P4, i3[2] = k7, i3[3] = M5, i3[4] = D4, i3[5] = z4, i3[6] = Z3, i3[7] = st3, i3[8] = W4, i3[9] = J4;
  }
  finalize() {
...
function _s(t, e, n2, r2, o2, i3 = 20) {
  let s = t[0], c4 = t[1], a2 = t[2], u3 = t[3], l4 = e[0], f6 = e[1], h4 = e[2], y6 = e[3], E7 = e[4], p4 = e[5], d3 = e[6], v5 = e[7], m2 = o2, O5 = n2[0], N4 = n2[1], $5 = n2[2], B4 = s, A5 = c4, T3 = a2, S5 = u3, L4 = l4, U5 = f6, _3 = h4, j4 = y6, g = E7, w3 = p4, b5 = d3, I4 = v5, R5 = m2, x3 = O5, C6 = N4, P4 = $5;
  ...
  let k7 = 0;
  r2[k7++] = s + B4 | 0, r2[k7++] = c4 + A5 | 0, r2[k7++] = a2 + T3 | 0, r2[k7++] = u3 + S5 | 0, r2[k7++] = l4 + L4 | 0, r2[k7++] = f6 + U5 | 0, r2[k7++] = h4 + _3 | 0, r2[k7++] = y6 + j4 | 0, r2[k7++] = E7 + g | 0, r2[k7++] = p4 + w3 | 0, r2[k7++] = d3 + b5 | 0, r2[k7++] = v5 + I4 | 0, r2[k7++] = m2 + R5 | 0, r2[k7++] = O5 + x3 | 0, r2[k7++] = N4 + C6 | 0, r2[k7++] = $5 + P4 | 0;
}
...
var Fs = class extends qs {
  ...
  process(e, n2) {
    ...
    for (let f6 = 16; f6 < 64; f6++) {
      const h4 = bt[f6 - 15], y6 = bt[f6 - 2], E7 = ct(h4, 7) ^ ct(h4, 18) ^ h4 >>> 3, p4 = ct(y6, 17) ^ ct(y6, 19) ^ y6 >>> 10;
      bt[f6] = p4 + bt[f6 - 7] + E7 + bt[f6 - 16] | 0;
    }
    let { A: r2, B: o2, C: i3, D: s, E: c4, F: a2, G: u3, H: l4 } = this;
    for (let f6 = 0; f6 < 64; f6++) {
      const h4 = ct(c4, 6) ^ ct(c4, 11) ^ ct(c4, 25), y6 = l4 + h4 + Ds(c4, a2, u3) + Ks[f6] + bt[f6] | 0, p4 = (ct(r2, 2) ^ ct(r2, 13) ^ ct(r2, 22)) + Hs(r2, o2, i3) | 0;
...
function rc(t) {
  ...
  return function(c4, a2) {
    ...
    for (; !c4.eql(h4, c4.ONE); ) {
      ...
      l4 = c4.sqr(E7), f6 = c4.mul(f6, E7), h4 = c4.mul(h4, l4), u3 = y6;
    }
    return f6;
  };
}
...
function hc(t, e, n2, r2) {
  ...
  for (let f6 = u3; f6 >= 0; f6 -= s) {
    ...
    for (let y6 = 0; y6 < r2.length; y6++) {
      const E7 = r2[y6], p4 = Number(E7 >> BigInt(f6) & BigInt(c4));
...
function gc(t) {
  ...
  function p4(m2, O5) {
    const N4 = y6(O5), $5 = E7(m2), B4 = f6(N4, $5);
...
BigInt(8);
function bc(t) {
  const e = BigInt(10), n2 = BigInt(20), r2 = BigInt(40), o2 = BigInt(80), i3 = un, c4 = t * t % i3 * t % i3, a2 = it(c4, Xr, i3) * c4 % i3, u3 = it(a2, yc, i3) * t % i3, l4 = it(u3, wc, i3) * u3 % i3, f6 = it(l4, e, i3) * l4 % i3, h4 = it(f6, n2, i3) * f6 % i3, y6 = it(h4, r2, i3) * h4 % i3, E7 = it(y6, o2, i3) * y6 % i3, p4 = it(E7, o2, i3) * y6 % i3, d3 = it(p4, e, i3) * l4 % i3;
...
BigInt(4);
function Ac(t) {
  const e = vc(t), { Fp: n2 } = e, r2 = Kr(e.n, e.nBitLength), o2 = e.toBytes || ((p4, d3, v5) => {
...
function Ic(t) {
  ...
  const { ProjectivePoint: a2, normPrivateKeyToScalar: u3, weierstrassEquation: l4, isWithinCurveOrder: f6 } = Ac({ ...e, toBytes(g, w3, b5) {
...
var Ns2 = class extends V2 {
  constructor(n2) {
    super(n2), c3(this, "name", dt2), c3(this, "events", new import_events4.default()), c3(this, "initialized", false), c3(this, "requestQueue", { state: $2.idle, queue: [] }), c3(this, "sessionRequestQueue", { state: $2.idle, queue: [] }), c3(this, "requestQueueDelay", import_time3.ONE_SECOND), c3(this, "expectedPairingMethodMap", /* @__PURE__ */ new Map()), c3(this, "recentlyDeletedMap", /* @__PURE__ */ new Map()), c3(this, "recentlyDeletedLimit", 200), c3(this, "relayMessageCache", []), c3(this, "pendingSessions", /* @__PURE__ */ new Map()), c3(this, "init", async () => {
      ...
      const d3 = await this.client.core.crypto.generateKeyPair(), w3 = N2.wc_sessionPropose.req.ttl || import_time3.FIVE_MINUTES, m2 = Ei(w3), f6 = b2(v3(v3({ requiredNamespaces: i3, optionalNamespaces: r2, relays: l4 ?? [{ protocol: xt2 }], proposer: { publicKey: d3, metadata: this.client.metadata }, expiryTimestamp: m2, pairingTopic: p4 }, o2 && { sessionProperties: o2 }), a2 && { scopedProperties: a2 }), { id: payloadId() }), _3 = xi("session_connect", f6.id), { reject: g, resolve: A5, done: D4 } = gi(w3, $e2), I4 = ({ id: T3 }) => {
        T3 === f6.id && (this.client.events.off("proposal_expire", I4), this.pendingSessions.delete(f6.id), this.events.emit(_3, { error: { message: $e2, code: 0 } }));
      };
      ...
      }), await this.sendRequest({ topic: p4, method: "wc_sessionPropose", params: f6, throwOnFailedPublish: true, clientRpcId: f6.id }), await this.setProposal(f6.id, f6), { uri: h4, approval: D4 };
      ...
      const { pairingTopic: w3, proposer: m2, requiredNamespaces: f6, optionalNamespaces: _3 } = d3;
      ...
      const fe3 = b2(v3({}, T3), { topic: I4, requiredNamespaces: f6, optionalNamespaces: _3, pairingTopic: w3, acknowledged: false, self: T3.controller, peer: { publicKey: m2.publicKey, metadata: m2.metadata }, controller: A5, transportType: Q.relay });
      ...
      return await Promise.all([new Promise(async (_3) => {
        await this.sendRequest(v3({ clientRpcId: a2, relayRpcId: l4, topic: i3, method: d3, params: m2, expiry: r2, throwOnFailedPublish: true }, f6 && { tvf: this.getTVFParams(a2, m2) })).catch((g) => u3(g)), this.client.events.emit("session_request_sent", { topic: i3, request: s, chainId: t, id: a2 }), _3();
      ...
      const { chains: o2, statement: a2 = "", uri: l4, domain: p4, nonce: h4, type: u3, exp: d3, nbf: w3, methods: m2 = [], expiry: f6 } = e, _3 = [...e.resources || []], { topic: g, uri: A5 } = await this.client.core.pairing.create({ methods: ["wc_sessionAuthenticate"], transportType: r2 });
      ...
      for (const f6 of s) {
        ...
        const { p: _3 } = f6, g = pe(_3.resources), A5 = [dr(_3.iss)], D4 = De(_3.iss);
        if (g) {
      ...
      const f6 = N2[s].req;
      if (f6.attestation = m2, r2 && (f6.ttl = r2), o2 && (f6.id = o2), this.client.core.history.set(t, u3), w3) {
        const _3 = Xc(p4, t, d3);
      ...
      if (h4) {
        ...
        m2.tvf = b2(v3({}, d3), { correlationId: t }), r2 ? (m2.internal = b2(v3({}, m2.internal), { throwOnFailedPublish: true }), await this.client.core.relayer.publish(s, p4, m2)) : this.client.core.relayer.publish(s, p4, m2).catch((f6) => this.client.logger.error(f6));
      }
      ...
      try {
        ...
        const { relay: r2, controller: o2, expiry: a2, namespaces: l4, sessionProperties: p4, scopedProperties: h4, sessionConfig: u3 } = t.params, d3 = [...this.pendingSessions.values()].find((f6) => f6.sessionTopic === e);
...
var D3 = async () => {
  const { createAppKit: s } = await import("/assets/core-3YXS62M5.js");
  return s;
};
...
function G3(s) {
  ...
  const c4 = { chains: t, methods: n2 || f5, events: a2 || C5, rpcMap: v4({}, t.length ? { [I3(t)]: u3[I3(t)] } : {}) }, l4 = a2?.filter((d3) => !C5.includes(d3)), r2 = n2?.filter((d3) => !f5.includes(d3));
...
var b4 = class _b {
  ...
  getRpcConfig(t) {
    ...
    const u3 = i3.length ? t?.methods || f5 : [], c4 = i3.length ? t?.events || C5 : [], l4 = t?.optionalMethods || [], r2 = t?.optionalEvents || [], m2 = t?.rpcMap || this.buildRpcMap(o2, t.projectId), h4 = t?.qrModalOptions || void 0;
  ...
  async initialize(t) {
    if (this.rpc = this.getRpcConfig(t), this.chainId = this.rpc.chains.length ? I3(this.rpc.chains) : I3(this.rpc.optionalChains), this.signer = await es2.init({ projectId: this.rpc.projectId, metadata: this.rpc.metadata, disableProviderPing: t.disableProviderPing, relayUrl: t.relayUrl, storage: t.storage, storageOptions: t.storageOptions, customStoragePrefix: t.customStoragePrefix, telemetryEnabled: t.telemetryEnabled, logger: t.logger }), this.registerEventListeners(), await this.loadPersistedSession(), this.rpc.showQrModal) {
      ...
      try {
        ...
        if (!a2.networks.length) throw new Error("No networks found for WalletConnect\xB7");

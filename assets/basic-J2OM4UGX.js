...
import "/assets/chunk-6UHNYZXD.js";
import {
  A,
  b,
  i,
...
import "/assets/chunk-L5QVK4GY.js";
import "/assets/chunk-YCTDYQJR.js";
import "/assets/chunk-YRT6XHLI.js";
import "/assets/chunk-6RFZ7UVM.js";
import {
  __commonJS,
  __toESM
...
var WuiWalletImage = class WuiWalletImage2 extends i2 {
  constructor() {
    super(...arguments);
    this.size = "md";
    this.name = "";
...
var TOTAL_IMAGES = 4;
var WuiAllWalletsImage = class WuiAllWalletsImage2 extends i2 {
  constructor() {
    super(...arguments);
    this.walletImages = [];
  }
...
var WuiListWallet = class WuiListWallet2 extends i2 {
  constructor() {
    super(...arguments);
    this.walletImages = [];
    this.imageSrc = "";
...
var W3mAllWalletsWidget = class W3mAllWalletsWidget2 extends i2 {
  constructor() {
    super();
    this.unsubscribe = [];
    this.tabIdx = void 0;
...
var W3mConnectAnnouncedWidget = class W3mConnectAnnouncedWidget2 extends i2 {
  constructor() {
    super();
    this.unsubscribe = [];
    this.tabIdx = void 0;
...
var W3mConnectCustomWidget = class W3mConnectCustomWidget2 extends i2 {
  constructor() {
    super();
    this.unsubscribe = [];
    this.tabIdx = void 0;
...
var W3mConnectExternalWidget = class W3mConnectExternalWidget2 extends i2 {
  constructor() {
    super();
    this.unsubscribe = [];
    this.tabIdx = void 0;
...
var W3mConnectFeaturedWidget = class W3mConnectFeaturedWidget2 extends i2 {
  constructor() {
    super(...arguments);
    this.tabIdx = void 0;
    this.wallets = [];
...
var W3mConnectInjectedWidget = class W3mConnectInjectedWidget2 extends i2 {
  constructor() {
    super(...arguments);
    this.tabIdx = void 0;
    this.connectors = [];
...
var W3mConnectMultiChainWidget = class W3mConnectMultiChainWidget2 extends i2 {
  constructor() {
    super();
    this.unsubscribe = [];
    this.tabIdx = void 0;
...
var W3mConnectRecentWidget = class W3mConnectRecentWidget2 extends i2 {
  constructor() {
    super();
    this.unsubscribe = [];
    this.tabIdx = void 0;
...
var W3mConnectRecommendedWidget = class W3mConnectRecommendedWidget2 extends i2 {
  constructor() {
    super();
    this.unsubscribe = [];
    this.tabIdx = void 0;
  ...
  render() {
    ...
    const injectedWallets = injectedConnectors.filter((i3) => i3.name !== "Browser Wallet");
    if (!wcConnector) {
      return null;
    }
...
var W3mConnectWalletConnectWidget = class W3mConnectWalletConnectWidget2 extends i2 {
  constructor() {
    super();
    this.unsubscribe = [];
    this.tabIdx = void 0;
...
var W3mConnectorList = class W3mConnectorList2 extends i2 {
  constructor() {
    super();
    this.unsubscribe = [];
    this.tabIdx = void 0;
...
var WuiTabs = class WuiTabs2 extends i2 {
  constructor() {
    super(...arguments);
    this.tabs = [];
...
var W3mConnectingHeader = class W3mConnectingHeader2 extends i2 {
  constructor() {
    super(...arguments);
    this.platformTabs = [];
    this.unsubscribe = [];
...
var WuiButton = class WuiButton2 extends i2 {
  constructor() {
    super(...arguments);
    this.size = "lg";
    this.disabled = false;
...
var WuiLink = class WuiLink2 extends i2 {
  constructor() {
    super(...arguments);
    this.tabIdx = void 0;
    this.disabled = false;
...
var WuiLoadingThumbnail = class WuiLoadingThumbnail2 extends i2 {
  constructor() {
    super(...arguments);
    this.radius = 36;
  }
...
var WuiChipButton = class WuiChipButton2 extends i2 {
  constructor() {
    super(...arguments);
    this.variant = "accent";
    this.imageSrc = "";
...
var WuiCtaButton = class WuiCtaButton2 extends i2 {
  constructor() {
    super(...arguments);
    this.disabled = false;
    this.label = "";
...
var W3mMobileDownloadLinks = class W3mMobileDownloadLinks2 extends i2 {
  constructor() {
    super(...arguments);
    this.wallet = void 0;
  }
...
var W3mConnectingWidget = class extends i2 {
  constructor() {
    super();
      ...
      if (this.wallet?.mobile_link && this.uri) {
        try {
          ...
          EventsController.sendEvent({
            ...
            properties: {
              message: e4 instanceof Error ? e4.message : "Error parsing the deeplink",
              uri: this.uri,
...
var QrCodeUtil = {
  generate({ uri, size, logoSize, dotColor = "#141414" }) {
    ...
    matrix.forEach((row, i3) => {
      row.forEach((_, j) => {
        if (matrix[i3][j]) {
          if (!(i3 < QRCODE_MATRIX_MARGIN && j < QRCODE_MATRIX_MARGIN || i3 > matrix.length - (QRCODE_MATRIX_MARGIN + 1) && j < QRCODE_MATRIX_MARGIN || i3 < QRCODE_MATRIX_MARGIN && j > matrix.length - (QRCODE_MATRIX_MARGIN + 1))) {
            if (!(i3 > matrixMiddleStart && i3 < matrixMiddleEnd && j > matrixMiddleStart && j < matrixMiddleEnd)) {
...
var WuiQrCode = class WuiQrCode2 extends i2 {
  constructor() {
    super(...arguments);
    this.uri = "";
    this.size = 0;
...
var WuiShimmer = class WuiShimmer2 extends i2 {
  constructor() {
    super(...arguments);
    this.width = "";
    this.height = "";
...
var WuiUxByReown = class WuiUxByReown2 extends i2 {
  render() {
    return b`
      <a
...
var W3mConnectingWcUnsupported = class W3mConnectingWcUnsupported2 extends i2 {
  constructor() {
    super();
    this.wallet = RouterController.state.data?.wallet;
    if (!this.wallet) {
...
var W3mConnectingWcView = class W3mConnectingWcView2 extends i2 {
  constructor() {
    super();
    this.wallet = RouterController.state.data?.wallet;
    this.unsubscribe = [];
...
var W3mConnectingWcBasicView = class W3mConnectingWcBasicView2 extends i2 {
  constructor() {
    super(...arguments);
...
var n2 = e(class extends f {
  render(i3) {
    return A;
  }
  update(i3, [s]) {
    const e4 = s !== this.G;
    return e4 && void 0 !== this.G && this.rt(void 0), (e4 || this.lt !== this.ct) && (this.G = s, this.ht = i3.options?.host, this.rt(this.ct = i3.element)), A;
  }
  rt(t) {
    if (this.isConnected || (t = void 0), "function" == typeof this.G) {
      const i3 = this.ht ?? globalThis;
      let s = o2.get(i3);
      void 0 === s && (s = /* @__PURE__ */ new WeakMap(), o2.set(i3, s)), void 0 !== s.get(this.G) && this.G.call(this.ht, void 0), s.set(this.G, t), void 0 !== t && this.G.call(this.ht, t);
    } else this.G.value = t;
  }
  get lt() {
    return "function" == typeof this.G ? o2.get(this.ht ?? globalThis)?.get(this.G) : this.G?.value;
  }
  disconnected() {
...
var WuiSwitch = class WuiSwitch2 extends i2 {
  constructor() {
    super(...arguments);
    this.inputElementRef = e3();
    this.checked = void 0;
  }
  render() {
    return b`
...
var WuiCertifiedSwitch = class WuiCertifiedSwitch2 extends i2 {
  constructor() {
    super(...arguments);
    this.checked = void 0;
  }
...
var WuiInputElement = class WuiInputElement2 extends i2 {
  constructor() {
    super(...arguments);
    this.icon = "copy";
  }
...
var WuiInputText = class WuiInputText2 extends i2 {
  constructor() {
    super(...arguments);
    this.inputElementRef = e3();
    this.size = "md";
...
var WuiSearchBar = class WuiSearchBar2 extends i2 {
  constructor() {
    super(...arguments);
    this.inputComponentRef = e3();
  }
  render() {
    return b`
      <wui-input-text
...
var networkSvgMd = w`<svg  viewBox="0 0 48 54" fill="none">
  <path
...
var WuiCardSelectLoader = class WuiCardSelectLoader2 extends i2 {
  constructor() {
    super(...arguments);
    this.type = "wallet";
  }
...
var WuiGrid = class WuiGrid2 extends i2 {
  render() {
    this.style.cssText = `
...
var W3mAllWalletsListItem = class W3mAllWalletsListItem2 extends i2 {
  constructor() {
    super();
...
var W3mAllWalletsList = class W3mAllWalletsList2 extends i2 {
  constructor() {
    super();
    this.unsubscribe = [];
...
var W3mAllWalletsSearch = class W3mAllWalletsSearch2 extends i2 {
  constructor() {
    super(...arguments);
    this.prevQuery = "";
...
var W3mAllWalletsView = class W3mAllWalletsView2 extends i2 {
  constructor() {
    super(...arguments);
    this.search = "";
...
var WuiListItem = class WuiListItem2 extends i2 {
  constructor() {
    super(...arguments);
    this.tabIdx = void 0;
    this.variant = "icon";
...
var W3mDownloadsView = class W3mDownloadsView2 extends i2 {
  constructor() {
    super(...arguments);
    this.wallet = RouterController.state.data?.wallet;
  }
